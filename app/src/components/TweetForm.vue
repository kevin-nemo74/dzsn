    ...
    <div v-if="connected" class="px-8 py-4 border-b">
        ...
        <div class="flex flex-wrap items-center justify-between -m-2">
            ...
            <div class="relative m-2 mr-4">
                <input type="text" placeholder="topic" class="text-purple-500 rounded-full pl-10 pr-4 py-2 bg-gray-100"
                ...
                <div class="absolute left-0 inset-y-0 flex pl-3 pr-2">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 m-auto"
                        :class="effectiveTopic ? 'text-purple-500' : 'text-gray-400'" viewBox="0 0 20 20"
                        fill="currentColor">
            ...
            <div class="flex items-center space-x-6 m-2 ml-auto">
                ...
                <button class="text-white px-4 py-2 rounded-full font-semibold" :disabled="!canTweet"
                    :class="canTweet ? 'bg-purple-500' : 'bg-purple-300 cursor-not-allowed'" @click="send">
                    Tweet
                </button>
            </div>
        </div>
